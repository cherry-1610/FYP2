                ...
                <div class="signup-form">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col"><input type="text" class="form-control" name="A_username"
                                        placeholder="Username" required="required"></div>
                                <div class="col"><input type="password" class="form-control" name="A_password"
                                        placeholder="Password" required="required"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control" name="A_email" placeholder="Email"
                                required="required">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="A_companyName" placeholder="Company Name"
                                required="required">
                        </div>
                        <div class="form-group">
